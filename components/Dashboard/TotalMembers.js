...
const TotalMembers = () => {
  return (
    <div className="sm:flex-1 h-[420px] sm:h-[318px] bg-white  rounded-[10px] pt-[19px] pb-[15px] px-[13px] min-w-[300px] ">
      {/* Heading start */}
      <div>
      ...
      <div className="flex gap-3 flex-wrap -mt-32 sm:-mt-20">
        {data?.map((item, index) => {
          return (
            <div
            ...
            >
              ...
              ></div>
              <h1 className="text-gray-700 mb-[0.4px] font-medium text-sm">
                <span className="font-semibold">{"20% "}</span> {item?.name}
              </h1>
            </div>
          );
        })}
