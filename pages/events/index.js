                            ...
                            <table className='w-full '>
                                <thead>
                                    <tr className='bg-[#F8F9FA]   text-left'>
                                        ...
                                        <th className=' py-[12px]  font-medium  lg:font-semibold  text-base  whitespace-nowrap lg:min-w-[150px] tracking-wide'>level/Category</th>
                                        <th className=' py-[12px]  font-medium  lg:font-semibold  text-base  whitespace-nowrap lg:min-w-[150px] tracking-wide'>Entry fees</th>
                                        <th className=' py-[12px]  font-medium  lg:font-semibold  text-base  whitespace-nowrap lg:min-w-[150px] tracking-wide'>Number of player</th>
                                        <th className=' py-[12px]  font-medium   lg:font-semibold  text-base whitespace-nowrap tracking-wide pr-5'>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
